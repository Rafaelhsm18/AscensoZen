...
const MISSIONS_LIST = [
    { id: 1, description: 'Recoge 25 almejas en una partida', type: 'FICHAS_EN_PARTIDA', target: 25, reward: 50 },
    { id: 2, description: 'Alcanza 5.000 puntos', type: 'PUNTOS_ALCANZADOS', target: 5000, reward: 75 },
    { id: 3, description: 'Sobrevive 60 segundos', type: 'TIEMPO_SOBREVIVIDO', target: 60, reward: 100 },
    { id: 4, description: 'Juega 3 partidas', type: 'PARTIDAS_JUGADAS', target: 3, reward: 40 }
];
...
class PreloaderScene extends Phaser.Scene {
    ...
    preload() {
        ...
        // --- AÑADIDO: Carga del nuevo sonido de impulso ---
...
class GameScene extends Phaser.Scene {
    ...
    init(data) { this.score = data.score || 0; this.fichas = data.fichas || 0; this.hasContinued = data.hasContinued || false; }
     create() {
        ...
        this.anims.create({
            key: 'crab_pinch',
            frames: [ { key: 'obstacle_cangrejo' }, { key: 'cangrejo_cerrado' } ],
            frameRate: 2,
            repeat: -1
        });
